...
class TestAlbertHeijnScraper(ScraperTest):
    ...
    def test_title(self):
        self.assertEqual(
            "Volkoren mac and cheese met pompoen", self.harvester_class.title()
        )
    ...
    def test_image(self):
        self.assertEqual(
            "https://static.ah.nl/static/recepten/img_RAM_PRD143023_890x594_JPG.jpg",
    ...
    def test_instructions(self):
        self.assertEqual(
            "Snipper de ui heel fijn en snijd de knoflook fijn. Schil de pompoen, halveer en verwijder de draderige binnenkant en pitten. Snijd in blokjes van ca. 1 cm. Breng 2 pannen ruim water aan de kook. Kook de macaroni in 8 min. beetgaar in de ene pan en kook de pompoen 8 min. in de andere pan.\nVerhit ondertussen de olie in een koekenpan, fruit de ui en de helft van de knoflook 5-8 min. op laag vuur. Verwarm de oven voor op 200 °C. Giet de macaroni en pompoen af en bewaar een kopje van het pompoenkookvocht. Pureer de pompoen en het kookvocht met de staafmixer en meng de zuivelspread, nootmuskaat en chilivlokken erdoor tot een gladde saus.\nMeng de macaroni en pompoen, de helft van de geraspte kaas en het gebakken knoflook-uimengsel. Schep in de ovenschaal. Meng de rest van de geraspte kaas met de rest van de knoflook. Verdeel over de schaal. Bak de mac and cheese ca. 25 min. tot goudgeel en knapperig.",
